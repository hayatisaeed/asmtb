...
def main():
    ...
    admin_manage_sub_handler = ConversationHandler(
        ...
        states={
            'CHOOSING': [
                ...
                MessageHandler(filters.Regex('^رایگان کردن برای همه$'),
                               core.handlers.admin_handlers.sub_handler.make_bot_free_for_all),
                MessageHandler(filters.ALL,
                               core.handlers.user_handlers.basic_settings_handler.return_home)
            ],
            'FREE_GET_ID': [
    ...
    user_sub_handler = ConversationHandler(
        entry_points=[
            MessageHandler(filters.Regex('^💳 اشتراک ماهانه$'),
                           core.handlers.user_handlers.sub_handler.handle)
        ],
        states={
            'CHOOSING': [
                MessageHandler(filters.Regex('^🔙 | بازگشت به منوی اصلی$'),
                               core.handlers.user_handlers.basic_settings_handler.return_home),
                MessageHandler(filters.Regex('^خرید یا تمدید اشتراک$'),
                               core.handlers.user_handlers.sub_handler.buy_sub),
                MessageHandler(filters.Regex('^وضعیت اشتراک من$'),
                               core.handlers.user_handlers.sub_handler.show_my_sub_status),
                MessageHandler(filters.ALL,
                               core.handlers.user_handlers.basic_settings_handler.return_home)
            ]
        },
    ...
    user_buy_sub_handler = CallbackQueryHandler(
        core.handlers.user_handlers.sub_handler.buy_sub_do,
